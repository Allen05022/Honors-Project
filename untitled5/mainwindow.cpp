...
#include <QMessageBox>
 ...
 std::vector<Patient>* list_of_people = new   std::vector<Patient>;

 std::string IllnessIntTostring(int value) {
...
void MainWindow::on_pushButton_clicked()
{
      ...
      ui->label_7->setText("Gathered Information : "   + QString::fromStdString( std::to_string(list_of_people->size())));
      QMessageBox msgBox;
...
{
    //elder illness
    auto all_illnesses = new  std::vector<IllnessCategory>;
...
void MainWindow::on_pushButton_4_clicked()
{
     ...
     int result = 0;
      ...
      QMessageBox msgBox;
      msgBox.setText("Operation");
      msgBox.setInformativeText("Age average of students is " +   QString::fromStdString (  std::to_string( result)));
      msgBox.setStandardButtons(QMessageBox::Ok);
      msgBox.setDefaultButton(QMessageBox::Ok);
      msgBox.exec();
}
